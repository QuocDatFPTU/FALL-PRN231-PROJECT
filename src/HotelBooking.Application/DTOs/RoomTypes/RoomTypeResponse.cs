...
public class RoomTypeResponse : BaseAuditableEntity, IMapFrom<RoomType>
{
    ...
    public ICollection<RoomTypeGroupResponse> RoomTypeGroups { get; set; } = new HashSet<RoomTypeGroupResponse>();
}
